...
function Hero() {
  return (
    <div className="bg-light-primary dark:bg-dark-primary grainey_background" style={{ borderRadius: "0 0 80px 80px" }}>
      <NavBar />
      ...
      <div className="m-auto text-center w-1/2 text-2xl md:text-4xl lg:text-5xl font-medium mt-12 text-slate-800 dark:text-light-secondary">
