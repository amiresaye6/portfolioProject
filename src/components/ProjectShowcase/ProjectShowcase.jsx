  ...
  return (
    <div className="p-10 space-y-12  ">
      {projects.map((project, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-row items-center bg-gray-200 dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-transform transform hover:scale-105 duration-300"
        >
          {/* Project Image */}
